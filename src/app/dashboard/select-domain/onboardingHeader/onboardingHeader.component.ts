...
export class OnboardingHeaderComponent implements OnInit {
  ...
  ngOnInit() {
    this.allLinks = {
      "website": {website: true, facebook: false, partners: false, care: false,  textToShow : "Please select a domain name for your website. Your website will be immediately available at <domain>.cureyo.com", 
              headingToShow : "Create your Website", 
              takeNext : false, nextURL: "NA"},
      "web": {website: true, facebook: false, partners: false, care: false,  textToShow : "Please select a template for the website. Currently only one template is available. Please click on 'Modified Gaia Template'", 
              headingToShow : "Create your Website", 
              takeNext : false, nextURL: "NA"},
      "webform": {website: true, facebook: false, partners: false, care: false,  textToShow : "Congratulations! Your website is ready. You can preview it below. Please UPDATE YOUR AVAILABILITY and review all the content provided, especially 'Brief' and 'Specializations'. Click on 'Done' when completed.", 
              headingToShow : "Create your Website", 
              takeNext : true, nextURL: "partners"},
      "Ads": {website: false, facebook: true, partners: false, care: false,  textToShow : "Let's get started with some Facebook Advertising for your site. We have pre-created ad templates for each of your specialization. You can modify these or create new ads. Click on 'Done' when completed.", 
              headingToShow : "Plan your Social Media presence", 
              takeNext : true, nextURL: "dashboard"},
      "partners": {website: false, facebook: false, partners: true, care: false,  textToShow : "Now, you can add 'Partners' for your clinic. Partners can be other Consultants (e.g., Dieticians, other Specialists) to whom you refer cases OR Vendors, such as Labs or Pharmacies. Click on 'Done' when completed.", 
              headingToShow : "Create your Ecosystem", 
              takeNext : true, nextURL: "patient-hx-forms"},
      "patient-hx-forms": {website: false, facebook: false, partners: false, care: true,  textToShow : "Here, you can create Medical History forms for your incoming patients. Patients will be asked to update their data in these forms before they walk into your chambers. We have created a few samples. You can view samples from the drop down or create your own forms. Click on 'Done' when completed.", 
              headingToShow : "Medical History Forms", 
              takeNext : true, nextURL: "care-paths"},
      "care-paths": {website: false, facebook: false, partners: false, care: true,  textToShow : "Finally, let's create a few Care Pathways. Care Pathways are treatment regimens that will be enforced to your patients through Facebook Messenger, based on your selection. Items include 'Check Points' which may be reminders for consultations/ tests or simple checks on the patient's health. Some samples are provided. You can view samples from the drop down or create your own forms. Click on 'Done' when completed.", 
